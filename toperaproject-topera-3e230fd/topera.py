...
if __name__ == '__main__':
	...
	P = parser.parse_args()
	#Mio
	print "Estos son los argumentos: %s" % P
	#for a in P
		#IODebug.displayInfo("Este es un argumento: %s" % a)
	...
	try:
		...
		#############Aquí por ejemplo, si se ha elegido el run_mode=idel scan, tengo que comprobar si se ha pasado el parámetro -id???? 
